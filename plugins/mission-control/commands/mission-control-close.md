---
description: "Mission Control — close: distill the program into the vault, then delete its working docs"
argument-hint: <program-slug>
---

Execute the **mission-control** skill in **close** mode. First read `skills/mission-control/SKILL.md` — it is authoritative; this command is only an entry point.
